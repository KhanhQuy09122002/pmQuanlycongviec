...
use Yii;
use app\modules\hanghoa\models\LoaiHangHoa;
use app\modules\hanghoa\models\search\LoaiHangHoaSearch;
...
class LoaiHangHoaController extends Controller
{
    ...
    {    
        $searchModel = new LoaiHangHoaSearch();
  		if(isset($_POST['search']) && $_POST['search'] != null){
            ...
            $searchModel = new LoaiHangHoaSearch(); // "reset"
    ...
    /**
     * Delete an existing LoaiHangHoa model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing LoaiHangHoa model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

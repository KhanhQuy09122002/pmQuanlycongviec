...
<div class="row" style="margin-top:20px">
	<div class="col-md-12">
		<h4 class="text-primary">Chọn thông tin lọc dữ liệu</h4>
	</div>
...
function InBaoCao(typereport) {
    $.ajax({
        type: 'POST',
        url: '/banhang/report/rp-theo-ca-hang-hoa-print?startdate=' + $('#startdate').val() + '&starttime=' + $('#starttime').val() + '&enddate=' + $('#enddate').val() + '&endtime=' + $('#endtime').val() + '&byuser='+ $('#byuser').val() + '&sortby='+ $('#sort').val() + '&bienbanfull=1',

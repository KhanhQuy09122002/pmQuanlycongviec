...
<div class="row text-center" style="width: 100%">
    <div class="col-md-12" style="width: 100%"> 
        ...
        <table id="table-tieu-de-1" style="width: 100%">
    		<tr>    		
    			<td colspan="2">
    				<span class="phieu-h1">BÁO CÁO DOANH THU BÁN HÀNG</span>
    			</td>    			
    		</tr>
    		<tr>
    		...
    		<tr>    			
    			<td style="text-align: left;width: 50%"><span>Nhân viên: <?= $byuser ? User::findOne($byuser)->ho_ten : 'Tất cả' ?></span></td>
    			<td style="text-align: left;width: 50%;"><span>Sắp xếp: </span>
    				<?= $sortby=='ngay'? 'Theo ngày xuất' : 'Theo số hóa đơn'  ?>
    			</td>
    		</tr> 		
    	</table>

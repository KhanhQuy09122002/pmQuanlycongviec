...
<div class="row text-center" style="width: 100%">
    <div class="col-md-12" style="width: 100%"> 
    	...
    	<table style="width: 100%; margin-top:5px;">
    		...
    		<tr>
    			<td style="text-align: center"><span style="font-size:14pt;font-weight:bold">BÁO CÁO CHI PHÍ THẦU PHỤ CHI TIẾT</span></td>
    		</tr>
    	</table>
    	...
    	<table style="width: 100%; margin-top:10px;">
    		<tr>
    			<td>
    				Họ tên: <?= $model->ten_thau_phu ?>			
    			</td>
    		</tr>
    		<tr>
    			<td>
    				Họ tên: <?= $model->ten_cong_viec ?>			
    			</td>
    		</tr>
    		<tr>
    			<td>
    	...
    	<table id="table-content" style="width: 100%; margin-top:5px;">
    		...
    		<tbody>
    			<?php 
    			$stt = 0;
    			foreach ($model->ctThauPhuThanhToanLichSus as $iVT=>$item){
    			    $stt++;
    			?>
    			<tr>
        			<td style="text-align:center"><?= $stt ?></td>
        			<td style="text-align:left"><?= $item->thauPhuThanhToan->so_hop_dong ?></td>

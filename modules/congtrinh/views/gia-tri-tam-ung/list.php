...
<div class="row">
	...
	<div class="col-md-6">
         ...
         <?= Html::a('<i class="fas fa fa-trash" aria-hidden="true"></i>&nbsp; Xóa dữ liệu',
                        ["/congtrinh/gia-tri-tam-ung/bulkdelete"],
                        [
          ...
          <div class="btn-group mt-2 mb-2">
			...
			<ul class="dropdown-menu" role="menu">
				...
				<li><span onClick="InCT('giatritamung')" class="sButton"><i class="fa fa-print"></i> In báo cáo (A4)</span></li>
				<!-- 
				<li class="divider"></li>
	...
	<div class="col-md-6" style="text-align: right">
		<span class="sTongTien">Tổng: <?= number_format($model->tongGiaTriTamUng, 0, ',', '.') ?> VND</span>
	</div>
</div>


<div class="table-responsive gttu-table-wrap">
<table id="tblTamUng"  class="table table-bordered table-hover table-striped w-100">
...
var table = new DataTable('#tblTamUng',{
	//paging: false,
    pageLength: 20,
    autoWidth: true,
    "language": {

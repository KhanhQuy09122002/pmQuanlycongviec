...
<div class="row text-center" style="width: 100%">
    <div class="col-md-12" style="width: 100%"> 
    	...
    	<table style="width: 100%; margin-top:5px;">
    		...
    		<tr>
    			<td style="text-align: center"><span style="font-size:14pt;font-weight:bold">BÁO CÁO GIÁ TRỊ TẠM ỨNG</span></td>
    		</tr>
    	</table>
    	...
    	<table id="table-content" style="width: 100%; margin-top:5px;">
    		...
    		<tbody>
    			<?php 
    			$stt = 0;
    			foreach ($model->giaTriTamUng as $iVT=>$item){
    			    $stt++;
    			?>
    			<tr>
    			...
    			<tr style="text-align:right;font-weight: bold">
        			...
        			<td><?= number_format($model->tongGiaTriTamUng, 0, ',', '.') ?></td>
        			<td></td>
        			<td></td>
    			</tr>

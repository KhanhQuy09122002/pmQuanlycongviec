...
<div class="row">
	<div class="col-md-12">
    	<h5>GIÁ TRỊ BẢO HÀNH</h5>
    </div>
	<div class="col-md-6">
		 <?= Html::a('<i class="fa fa-plus"></i> Thêm mới', 
                ['/congtrinh/gia-tri-bao-hanh/create', 'idCT' => $model->id], 
                [
         ...
         <?= Html::a('<i class="fas fa fa-trash" aria-hidden="true"></i>&nbsp; Xóa dữ liệu',
                        ["/congtrinh/gia-tri-bao-hanh/bulkdelete"],
                        [
         ...
         <div class="btn-group mt-2 mb-2">
			...
			<ul class="dropdown-menu" role="menu">
				...
				<li><span onClick="InCT('giatribaohanh')" class="sButton"><i class="fa fa-print"></i> In báo cáo (A4)</span></li>
				<!-- 
				<li class="divider"></li>
	...
	<div class="col-md-6" style="text-align: right">
		<span class="sTongTien">Tổng: <?= number_format($model->tongGiaTriBaoHanh, 0, ',', '.') ?> VND</span>
	</div>
</div>

<div class="table-responsive gtbh-table-wrap">
<table id="tblBaoHanh" class="table table-bordered table-hover table-striped w-100">
...
var table = new DataTable('#tblBaoHanh',{
	//paging: false,
    pageLength: 20,
    autoWidth: true,
    "language": {

...
<div class="row text-center" style="width: 100%">
    <div class="col-md-12" style="width: 100%"> 
    	...
    	<table style="width: 100%; margin-top:5px;">
    		...
    		<tr>
    			<td style="text-align: center"><span style="font-size:14pt;font-weight:bold">BÁO CÁO VẬT TƯ XUẤT KHO</span></td>
    		</tr>
    	</table>
    	...
    	<table id="table-content" style="width: 100%; margin-top:5px;">
    		<thead>
    			<tr style="font-weight:bold">
        			...
        			<td style="width:10%">Ngày thực hiện</td>   
        			<td style="width:27%">Tên vật tư</td>        			
        			<td style="width:10%">ĐVT</td>
        			<td style="width:10%">Số lượng</td>
        			<td style="width:10%">Đơn giá<br/>(VND)</td>
        			<td style="width:10%">Thành tiền<br/>(VND)</td>
        			<td style="width:10%">Nhân viên</td>
    		...
    		<tbody>
    			<?php 
    			$stt = 0;
    			foreach ($model->vatTuThanhToan as $iVT=>$item){
    			    $stt++;
    			?>
    			<tr>
        			...
        			<td style="text-align:right"><?= number_format($item->so_luong, 0, ',', '.') ?></td>
    			...
    			<tr style="text-align:right;font-weight: bold">
        			...
        			<td><?= number_format($model->tongVatTuThanhToan, 0, ',', '.') ?></td>
        			<td></td>
        			<td></td>
    			</tr>

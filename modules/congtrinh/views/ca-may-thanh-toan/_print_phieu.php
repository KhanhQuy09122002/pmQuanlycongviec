...
<div class="row text-center" style="width: 100%">
    <div class="col-md-12" style="width: 100%"> 
    	...
    	<table style="width: 100%; margin-top:5px;">
    		...
    		<tr>
    			<td style="text-align: center"><span style="font-size:14pt;font-weight:bold">BÁO CÁO CA MÁY</span></td>
    		</tr>
    	</table>
    	...
    	<table id="table-content" style="width: 100%; margin-top:5px;">
    		<thead>
    			<tr style="font-weight:bold">
        			...
        			<td style="width:20%">Tên ca máy</td>
    		...
    		<tbody>
    			<?php 
    			$stt = 0;
    			foreach ($model->caMayThanhToan as $iVT=>$item){
    			    $stt++;
    			?>
    			<tr>
        			<td style="text-align:center"><?= $stt ?></td>
        			<td style="text-align:left"><?= $item->ten_ca_may ?></td>
    			...
    			<tr style="text-align:right;font-weight: bold">
        			...
        			<td><?= number_format($model->tongCaMayThanhToan, 0, ',', '.') ?></td>
        			<td></td>
        			<td></td>
    			</tr>

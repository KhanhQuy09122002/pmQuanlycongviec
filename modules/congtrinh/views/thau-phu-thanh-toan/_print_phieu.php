...
<div class="row text-center" style="width: 100%">
    <div class="col-md-12" style="width: 100%"> 
    	...
    	<table style="width: 100%; margin-top:5px;">
    		...
    		<tr>
    			<td style="text-align: center"><span style="font-size:14pt;font-weight:bold">BÁO CÁO CHI PHÍ THẦU PHỤ</span></td>
    		</tr>
    	</table>
    	...
    	<table id="table-content" style="width: 100%; margin-top:5px;">
    		<thead>
    			<tr style="font-weight:bold">
        			...
        			<td style="width:20%">Tên công việc</td>
        			<td style="width:20%">Tên nhà thầu</td>
        			<td style="width:15%">Số HĐ</td>
        			<td style="width:15%">Tổng HĐ</td>   
        			<td style="width:15%">Đã TT</td>
        			<td style="width:15%">Còn lại</td>        			
    		...
    		<tbody>
    			<?php 
    			$stt = 0;
    			foreach ($model->thauPhuThanhToan as $iVT=>$item){
    			    $stt++;
    			?>
    			<tr>
        			<td style="text-align:center"><?= $stt ?></td>
        			<td style="text-align:left"><?= $item->ten_cong_viec ?></td>
        			<td style="text-align:left"><?= $item->ten_thau_phu ?></td>
        			<td style="text-align:left"><?= $item->so_hop_dong ?></td>
    			...
    			<tr style="text-align:right;font-weight: bold">
        			...
        			<td><?= number_format($model->tongThauPhu, 0, ',', '.') ?></td>
        			<td><?= number_format($model->tongThauPhuDaThanhToan, 0, ',', '.') ?></td>
        			<td><?= number_format($model->tongThauPhuChuaThanhToan, 0, ',', '.') ?></td>
        			<td></td>
    			</tr>

...
$itemType = 'dathanhtoan';
?>

<div class="gttt" id="gtttContent">
<div class="row">
	<div class="col-md-12">
    	<h5>GIÁ TRỊ ĐÃ THANH TOÁN</h5>
    </div>
	<div class="col-md-6">
         ...
         <?= Html::a('<i class="fas fa fa-trash" aria-hidden="true"></i>&nbsp; Xóa dữ liệu',
                        ["/congtrinh/gia-tri-da-thanh-toan/bulkdelete"],
                        [
...
<div class="table-responsive gttt-table-wrap">
<table id="tblGiaTriDaThanhToan" class="table table-bordered table-hover table-striped w-100">
    <thead class="table-light">
        <tr>
            ...
            <th style="text-align: center;">Lần thanh toán</th>
...
var table = new DataTable('#tblGiaTriDaThanhToan',{
	//paging: false,
    pageLength: 20,
    autoWidth: true,
    "language": {

...
<div class="row text-center" style="width: 100%">
    <div class="col-md-12" style="width: 100%"> 
    	...
    	<table style="width: 100%; margin-top:5px;">
    		...
    		<tr>
    			<td style="text-align: center"><span style="font-size:14pt;font-weight:bold">BÁO CÁO GIÁ TRỊ ĐÃ THANH TOÁN</span></td>
    		</tr>
    	</table>
    	...
    	<table id="table-content" style="width: 100%; margin-top:5px;">
    		<thead>
    			<tr style="font-weight:bold">
        			...
        			<td style="width:20%">Lần thanh toán</td>
        			<td style="width:15%">Ngày thực hiện</td>   
        			<td style="width:20%">Số tiền</td>        			
        			<td style="width:20%">Nhân viên</td>
        			<td style="width:32%">Ghi chú</td>
    			</tr>
    		</thead>
    		<tbody>
    			<?php 
    			$stt = 0;
    			foreach ($model->giaTriDaThanhToan as $iVT=>$item){
    			    $stt++;
    			?>
    			<tr>
        			<td style="text-align:center"><?= $stt ?></td>
        			<td style="text-align:left"><?= $item->ten_lan_thanh_toan ?></td>
    			...
    			<tr style="text-align:right;font-weight: bold">
        			...
        			<td><?= number_format($model->tongGiaTriDaThanhToan, 0, ',', '.') ?></td>
        			<td></td>
        			<td></td>
    			</tr>

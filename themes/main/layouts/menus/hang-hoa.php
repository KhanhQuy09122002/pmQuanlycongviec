<li class="slide">
	<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
		...
		<span class="side-menu__label"><i class="fa fa-folder-o"></i> Quản lý hàng hóa</span><i class="angle fa fa-caret-right"></i>
	</a>
	<ul class="slide-menu" data-menu="hh">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="side7">
						<ul class="sidemenu-list">
							...
							<li><a href="<?= Yii::getAlias('@web/user/user-ajax?menu=hh1') ?>" class="slide-item" data-menu="ct1"><i class="fe fe-file-text"></i> Danh sách hàng hóa</a>
							</li>
						</ul>

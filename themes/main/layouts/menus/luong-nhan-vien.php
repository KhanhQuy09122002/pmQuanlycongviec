<li class="slide">
	<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
		...
		<span class="side-menu__label"><i class="fa fa-folder-o"></i> Quản lý lương</span><i class="angle fa fa-caret-right"></i>
	</a>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="side7">
						<ul class="sidemenu-list">
							...
							<li><a href="<?= Yii::getAlias('@web/luongnhanvien/nhan-vien-boc-vac?menu=nv1') ?>" class="slide-item" data-menu="nv1"><i class="fe fe-file-text"></i> Danh sách nhân viên</a>
							</li>
                            <li><a href="<?= Yii::getAlias('@web/luongnhanvien/luong-nhan-vien-boc-vac?menu=nv2') ?>" class="slide-item" data-menu="nv2"><i class="fe fe-file-text"></i> Bảng lương</a>
							</li>
						</ul>
